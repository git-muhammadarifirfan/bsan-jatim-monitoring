...
CREATE TABLE IF NOT EXISTS users (
  ...
  role          ENUM(
                  ...
                  'admin_pusat',        -- Admin Dinas Pendidikan Provinsi
                  'admin_kabupaten',    -- Admin Dinas Kabupaten/Kota
                  'admin_kecamatan',    -- Admin tingkat kecamatan
                  'operator_sekolah',   -- Operator input data per sekolah
                  'viewer'              -- Read-only untuk stakeholder
                ) NOT NULL DEFAULT 'viewer'
                COMMENT 'Role menentukan akses menu & data',
